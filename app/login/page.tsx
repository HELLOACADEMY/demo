              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{ width: '100%', padding: '10px 12px', border: '1px solid #c5d5e4', borderRadius: '4px', outline: 'none', fontSize: '0.875rem', background: '#fff' }}
                  >
                    <option value="br-1">Cabang Serdam Pontianak (Pusat)</option>
                    <option value="br-2">Cabang Karya Baru Pontianak</option>
                    <option value="br-3">Cabang Danau Sentarum Pontianak</option>
                  </select>
                </div>
